(function () {
    ...
    var pasOverlayDirective = function ($q, $timeout, $window, $rootScope, httpInterceptor) {
        return {
            restrict: 'EA',
            transclude: true,
            scope: {
            ...
            link: function (scope, element, attrs) {
                ...
                function processRequest() {
                    ...
                    if (queue.length == 1) {
                        ...
                        }, scope.pasOverlayDelay ? scope.pasOverlayDelay : 500); //Delay showing for 500 millis to avoid flicker
                    }
                }
                ...
                function processResponse() {
                    ...
                    if (queue.length == 0) {
                        ...
                        }, scope.pasOverlayDelay ? scope.pasOverlayDelay : 500);
                    }
                }
    ...
    var spiderPortalApp = angular.module('spiderPortal');
    ...
    spiderPortalApp.factory('httpInterceptor', function () {
        return {};
    });

    //Hook httpInterceptor factory into the $httpProvider interceptors so that we can monitor XHR calls
    spiderPortalApp.config(['$httpProvider', function ($httpProvider) {
    ...
    spiderPortalApp.directive('pasOverlay', ['$q', '$timeout', '$window', '$rootScope', 'httpInterceptor', pasOverlayDirective]);
